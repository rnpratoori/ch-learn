...
def main():
    ...
    model, optimizer, scheduler, start_epoch, epoch_losses, epoch_numbers = initialize_training(
        args, model, device, output_dir, checkpoint_filename="ch_learn_model.pth"
    )
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if (epoch + 1) % checkpoint_freq == 0 or epoch == num_epochs - 1:
            save_checkpoint(epoch, model, optimizer, scheduler, epoch_losses, epoch_numbers, output_dir, filename="ch_learn_model.pth")
